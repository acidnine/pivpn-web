...
if ($output == null) {
    ...
    $errorMessage = 'Error disabling user: Check if the file '.$file.' exists in the directory openvpn: "/etc/openvpn/ccd/" or wireguard: "/home/'.$username.'/configs/" or if it has the necessary permissions.';
